...
open class TabelaBDProduto (db: SQLiteDatabase) : TabelaBDProduto(db, NOME) {
    override fun cria() {
        db.execSQL("CREATE TABLE $nome (${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT, $Descricao_Produto TEXT NOT NULL," +
                " $Descricao_Produto TEXT NOT NULL, $Nome TEXT NOT NULL, $Quantidade TEXT NOT NULL, $Produto_ID TEXT NOT NULL)")
    }
